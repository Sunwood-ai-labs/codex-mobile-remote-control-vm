...
![ChatGPT Mobile Codex controls an Ubuntu VM thumbnail](../../assets/thumbnails/chatgpt-mobile-codex-proxmox-vm-en.png)
...
![Second ChatGPT/Codex mobile remote-control proof screenshot](../../assets/screenshots/mobile-remote-control-second-proof.png)
